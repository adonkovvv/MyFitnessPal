...
As a starting step of configuring the app to work, the text files should be present in order for the program to run. After creating users the program saves all the needed information in the text files, so it can work without database.
